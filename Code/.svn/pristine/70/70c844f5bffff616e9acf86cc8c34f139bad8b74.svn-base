...
#define LIFETIME_MUTE_COUT						(7920)					//22h
#define LOWBAT_MUTE_COUT						(3600)					//10h
#define LATCHING_CO_ALARM						(3)						
...
#define CAIL_BAT_LEVEL_MAX						(3300)
#define BATTERY_LEVEL_2_IN_3					(2800)


#define BATTERY_LEVEL_1_IN_3					(2700)
#define BATTERY_LEVEL_LOW						(2650)
