...
typedef enum _eEventSig
{
	...
	eEventSigKey1FourTimesClik,					//10
	eEventSigKey1LongClik,
...
#ifdef SUPPORT_SPEAK_FUNCTION
	uint8 LowPowerSpeakTimeCnt;
	uint8 EndLifeSpeakTimeCnt;
#endif
