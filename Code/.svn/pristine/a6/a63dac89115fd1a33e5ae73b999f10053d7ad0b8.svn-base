...
#define DevFaultCancel			((uint8_t)0x06)
...
#define LocationMsgNoLocation		((uint8_t)0x17)
#endif
...
#define UART_INT_is_L()			(UART_INT_IRQ_PIN == RESET)
#define UART_INT_is_H()			(UART_INT_IRQ_PIN != RESET)
#endif
